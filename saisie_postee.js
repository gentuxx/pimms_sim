...
(function() {
    ...
    if (document.getElementById("structure_selected").textContent.trim() == "Narbonne")
    {
        ...
        combobox.options[0] = new Option("-------------- Sur rendez-vous le matin --------------");
        combobox.options[0].disabled = true;

        combobox.options[1] = new Option("Retraite - Demande de retraite", "Retraite - Demande de retraite");
        combobox.options[2] = new Option("Retraite - Demande de réversion", "Retraite - Demande de réversion");
        combobox.options[3] = new Option("Retraite - Demande d'ASPA", "Retraite - Demande d'ASPA");
        combobox.options[4] = new Option("MDPH - Dossier MDPH", "MDPH - Dossier MDPH");
        combobox.options[5] = new Option("France Travail - Inscription", "France Travail - Inscription");
        combobox.options[6] = new Option("Logement social : 1ère demande", "Logement social : 1ère demande");

        combobox.options[7] = new Option("-------------- Sans rendez-vous l'après-midi --------------");
        combobox.options[7].disabled = true;

        combobox.options[8] = new Option("CAF - Déclaration des ressources", "CAF - Déclaration des ressources");
        combobox.options[9] = new Option("CAF - Réaliser une demande de RSA", "CAF - Réaliser une demande de RSA");
        combobox.options[10] = new Option("Comptes publics - Compléter une déclaration des revenus", "Comptes publics - Compléter une déclaration des revenus");
        combobox.options[11] = new Option("MSA", "MSA");
        combobox.options[12] = new Option("La Poste", "La Poste");
        combobox.options[13] = new Option("CPAM : Demande de CSS", "CPAM : Demande de CSS");
        combobox.options[14] = new Option("CPAM : Demande de carte vitale", "CPAM : Demande de carte vitale");
        combobox.options[15] = new Option("Justice : Extrait de casier judiciaire", "Justice : Extrait de casier judiciaire");
        combobox.options[16] = new Option("ANTS : Pré-demande CNI / Passeport", "ANTS : Pré-demande CNI / Passeport");
        combobox.options[17] = new Option("ANTS : Demande de permis de conduire", "ANTS : Demande de permis de conduire");
        combobox.options[18] = new Option("ANTS : Demande de RDV visite médicale de la préfecture", "ANTS : Demande de RDV visite médicale de la préfecture");
        combobox.options[19] = new Option("ANTS : Déclarer une cession de véhicule", "ANTS : Déclarer une cession de véhicule");
        combobox.options[20] = new Option("ANTS : Déclarer un achat de véhicule", "ANTS : Déclarer un achat de véhicule");
        combobox.options[21] = new Option("ANTS : Modifier une carte grise", "ANTS : Modifier une carte grise");
        combobox.options[22] = new Option("ANTS : Payer ou contester une amende", "ANTS : Payer ou contester une amende");
        combobox.options[23] = new Option("France Travail : Actualisation mensuelle", "France Travail : Actualisation mensuelle");
        combobox.options[24] = new Option("Logement social : Renouvellement", "Logement social : Renouvellement");
        combobox.options[25] = new Option("Ministère de l'écologie et des territoires", "Ministère de l'écologie et des territoires");
        combobox.options[26] = new Option("Service public : Demande extrait d'acte de naissance", "Service public : Demande extrait d'acte de naissance");
        combobox.options[27] = new Option("ANAH : Agence Nationale de l'Habitat", "ANAH : Agence Nationale de l'Habitat");
        ...
        function loadValues(event) {
            ...
            if (event.target == document.getElementById("fp-default")) {
                ...
                //--------------------------- Morning ---------------------------//
                if (comboboxValue == "Retraite - Demande de retraite") {
